...
- [YouTube kanallar](./youtube-channels.md) — har kunlik o'rganish uchun
- [Datasets](./datasets.md) — practice uchun dataset manbalari
- [Cheatsheets](./cheatsheets.md) — tez ko'rib qo'yish uchun
...
[Kitoblar ro'yxati](./books.md) bilan boshlang.
