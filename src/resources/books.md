...
- **"Python for Data Analysis"** — Wes McKinney (3-nashr, 2022, bepul online)
  ...
  - Bepul: [wesmckinney.com/book](https://wesmckinney.com/book/)
...
- **"Deep Learning with PyTorch"** — Eli Stevens, Luca Antiga, Thomas Viehmann
  ...
  - Bepul PDF: [pytorch.org/deep-learning-with-pytorch](https://pytorch.org/deep-learning-with-pytorch)
...
- **"Mathematics for Machine Learning"** — Deisenroth, Faisal, Ong (bepul PDF)
  ...
  - [mml-book.com](https://mml-book.com/)
...
- **"An Introduction to Statistical Learning (ISLR)"** — James, Witten, Hastie, Tibshirani (bepul)
  ...
  - [statlearning.com](https://www.statlearning.com/) (Python versiyasi ham bor)
...
| Math for ML | [mml-book.com](https://mml-book.com/) |
| ISLR | [statlearning.com](https://www.statlearning.com/) |
| Speech & Language Processing | [stanford.edu/~jurafsky/slp3](https://web.stanford.edu/~jurafsky/slp3/) |
...
| Machine Learning Yearning | [deeplearning.ai/program/machine-learning-yearning](https://www.deeplearning.ai/program/machine-learning-yearning/) |

[Onlayn kurslar](./courses.md) ga o'tish.
